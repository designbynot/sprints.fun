      ...
      <div className="max-w-4xl mx-auto">
        ...
        <article className="prose prose-lg max-w-none">
          ...
          <section>
            ...
            <img src="ETH_Qual_1.png" alt="ETH Qual 1" className="w-full rounded-lg mb-6" />
          ...
          <section>
            ...
            <img src="ETH_Qual_2.png" alt="ETH Qual 2" className="w-full rounded-lg mb-6" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <img src="ETH_Qual_3.png" alt="ETH Qual 3" className="w-full rounded-lg" />
              <img src="ETH_Qual_4.png" alt="ETH Qual 4" className="w-full rounded-lg" />
            </div>
            
            <p className="mb-6">The wireframe aesthetic also allows for night and dark mode composability.</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <img src="ETH_Qual_5.png" alt="ETH Qual 5" className="w-full rounded-lg" />
              <img src="ETH_Qual_6.png" alt="ETH Qual 6" className="w-full rounded-lg" />
            </div>
          </section>
          ...
          <section>
            ...
            <img src="by digital artist A.C.K.gif" alt="By digital artist A.C.K" className="w-full rounded-lg mb-2" />
            ...
            <img src="CryptoPunks by Larva Labs.png" alt="CryptoPunks by Larva Labs" className="w-full rounded-lg mb-2" />
            ...
            <img src="Base Layer 2 daily transactions.jpeg" alt="Base Layer 2 daily transactions" className="w-full rounded-lg mb-2" />
            ...
            <img src="Seed Club acquision.jpeg" alt="Seed Club acquisition" className="w-full rounded-lg mb-2" />
          ...
          <section>
            ...
            <img src="ETH Crystal.png" alt="ETH Crystal" className="w-full rounded-lg mb-6" />
