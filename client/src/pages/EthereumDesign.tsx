      ...
      <div className="max-w-4xl mx-auto">
        ...
        <article className="prose prose-lg max-w-none">
          ...
          <section>
            ...
            <img src="/EzBT-Qf0giWq27Ar.gif" alt="By digital artist A.C.K" className="w-full rounded-lg mb-2" />
            ...
            <img src="/ETH_Qual_7.png" alt="CryptoPunks by Larva Labs" className="w-full rounded-lg mb-2" />
            ...
            <img src="/GZs1YYiaAAIKaNt.jpeg" alt="Base Layer 2 daily transactions" className="w-full rounded-lg mb-2" />
            ...
            <img src="/GZi0hlNWMCQR-fV.jpeg" alt="Seed Club acquisition" className="w-full rounded-lg mb-2" />
          ...
          <section>
            ...
            <img src="/ETH_Qual_8.png" alt="ETH Crystal" className="w-full rounded-lg mb-6" />
